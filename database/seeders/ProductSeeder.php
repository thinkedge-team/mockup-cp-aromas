...
class ProductSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        Product::create([
            ...
            'features' => [
                ['icon' => 'bi-check-circle-fill', 'text' => 'Kemasan HDPE food-grade'],
                ['icon' => 'bi-check-circle-fill', 'text' => 'Tutup anti-tumpah presisi'],
                ['icon' => 'bi-check-circle-fill', 'text' => 'Ideal untuk 1-2 orang'],
            ],
            ...
            'whatsapp_message' => 'Halo AROMAS, saya tertarik dengan produk Botol Mini',
            'order' => 1,
            'is_active' => true,
        ]);
        ...
        Product::create([
            ...
            'features' => [
                ['icon' => 'bi-check-circle-fill', 'text' => 'Ekonomis & tahan lama'],
                ['icon' => 'bi-check-circle-fill', 'text' => 'Mudah dituang'],
                ['icon' => 'bi-check-circle-fill', 'text' => 'Ideal untuk 3-4 orang'],
            ],
            ...
            'whatsapp_message' => 'Halo AROMAS, saya tertarik dengan produk Botol Standar',
            'order' => 2,
            'is_active' => true,
        ]);
        ...
        Product::create([
            ...
            'features' => [
                ['icon' => 'bi-check-circle-fill', 'text' => 'Lebih hemat per liter'],
                ['icon' => 'bi-check-circle-fill', 'text' => 'Pegangan ergonomis'],
                ['icon' => 'bi-check-circle-fill', 'text' => 'Ideal untuk 5+ orang'],
            ],
            ...
            'whatsapp_message' => 'Halo AROMAS, saya tertarik dengan produk Botol Besar',
            'order' => 3,
            'is_active' => true,
        ]);
        ...
        Product::create([
            ...
            'features' => [
                ['icon' => 'bi-check-circle-fill', 'text' => 'Jeriken food-grade'],
                ['icon' => 'bi-check-circle-fill', 'text' => 'Tutup ulir rapat'],
            ...
            'whatsapp_message' => 'Halo AROMAS, saya tertarik dengan produk Jeriken Kecil',
            'order' => 1,
            'is_active' => true,
        ]);
        ...
        Product::create([
            ...
            'features' => [
                ['icon' => 'bi-check-circle-fill', 'text' => 'Handle kuat & ergonomis'],
                ['icon' => 'bi-check-circle-fill', 'text' => 'Dasar lebar & stabil'],
                ['icon' => 'bi-check-circle-fill', 'text' => 'Ideal untuk 6-8 orang'],
            ],
            ...
            'whatsapp_message' => 'Halo AROMAS, saya tertarik dengan produk Jeriken Sedang',
            'order' => 2,
            'is_active' => true,
        ]);
        ...
        Product::create([
            ...
            'features' => [
                ['icon' => 'bi-check-circle-fill', 'text' => 'Harga lebih ekonomis/liter'],
                ['icon' => 'bi-check-circle-fill', 'text' => 'Tahan lama & kuat'],
                ['icon' => 'bi-check-circle-fill', 'text' => 'Ideal untuk UMKM'],
            ],
            ...
            'whatsapp_message' => 'Halo AROMAS, saya tertarik dengan produk Jeriken Besar',
            'order' => 3,
            'is_active' => true,
        ]);
        ...
        Product::create([
            ...
            'features' => [
                ['icon' => 'bi-check-circle-fill', 'text' => 'Sistem tap mudah'],
                ['icon' => 'bi-check-circle-fill', 'text' => 'Kemasan sekunder box'],
                ['icon' => 'bi-check-circle-fill', 'text' => 'Ideal untuk HORECA'],
            ],
            ...
            'whatsapp_message' => 'Halo AROMAS, saya tertarik dengan produk BIB Standar',
            'order' => 1,
            'is_active' => true,
        ]);
        ...
        Product::create([
            ...
            'features' => [
                ...
                ['icon' => 'bi-check-circle-fill', 'text' => 'Harga termurah/liter'],
                ['icon' => 'bi-check-circle-fill', 'text' => 'Ideal untuk pabrik'],
            ],
            'modal_title' => 'AROMAS BIB Besar',
            'modal_subtitle' => 'Solusi enterprise dengan harga terbaik',
            'modal_details' => [
                ['label' => 'Kemasan', 'value' => 'Bag in Box industrial dengan tap'],
            ...
            'whatsapp_message' => 'Halo AROMAS, saya tertarik dengan produk BIB Besar',
            'order' => 2,
            'is_active' => true,
        ]);
    }
